class ResistorColorTrio {
  ...
  resistors. For this exercise, you need to know only three things about them:
      ...
      resistance values.
      Each band acts as a digit of a number. For example, if they printed
      a brown band (value 1) followed by a green band (value 5), it would
      translate to the number 15. In this exercise, you are going to create
    ...
    So an input of "orange", "orange", "black" should return:
        "33 ohms"
    When we get more than a thousand ohms, we say "kiloohms". That's similar
    to saying "kilometer" for 1000 meters, and "kilograms" for 1000 grams.
    So an input of "orange", "orange", "orange" should return:
        "33 kiloohms"
   */
  static List<String> colorsInput = ['Grey', 'Blue', 'Black']

  static void main(String[] args) {
    value(colorsInput)
  }

  static def value(List<String> colorsInput) {
    List<String> colors = ['Black', 'Brown', 'Red', 'Orange', 'Yellow',
    'Green', 'Blue', 'Violet', 'Grey', 'White']
    int value = (colors.indexOf(colorsInput[0]) * 10 + colors.indexOf(colorsInput[1]))
    * Math.pow(10, colors.indexOf(colorsInput[2]))
    if(value < 1000) {
      println(value + " ohms")
    } else {
      println(value/1000 + " kiloohms")
    }
  }
}
