class ResistorColorDuo {
  ...
  resistors. For this exercise, you need to know two things about them:
    ...
    resistance values. Each band has a position and a numeric value. For example,
    if they printed a brown band (value 1) followed by a green band (value 5),
    it would translate to the number 15.
  In this exercise you are going to create a helpful program so that you
  don't have to remember the values of the bands. The program will take color
  names as input and output a two digit number, even if the input is more
  than two colors!
   ...
   */
  static List<String> colorsInput = ['Grey', 'Blue', 'Green']

  static void main(String[] args) {
    println value(colorsInput)
  }
